...
void AboutMenu::Draw(SDL_Renderer* rR) {
	CCFG::getText()->DrawWS(rR, "MARIO V 1.03", 150, 128, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "AUTOR: Ariel Verbaza", 150, 146, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "Departamento de Informatica 2012-2016", 150, 188, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "Universidad de Panama", 150, 206, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "dsapandora 2014", 150, 224, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "dsapandora", 150, 264, 0, 0, 0);
